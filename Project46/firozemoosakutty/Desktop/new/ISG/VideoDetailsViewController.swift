...
class VideoDetailsViewController: UIViewController {
    ...
    @IBOutlet weak var ratingLabel: UILabel!{
        didSet{
            ...
            ratingLabel.layer.borderColor = UIColor.green.cgColor
        }
    }
    ...
    let productIds: Set<String> = ["com.isg.oneoff_threemonths","com.isg.monthly","com.isg.yearly"]
    override func viewDidLoad() {
        ...
        seasonTableView.backgroundColor = ThemeManager.currentTheme().backgroundColor
                        ...
                        DispatchQueue.main.async {
                            ...
                            if let showVideoList = self.ShowData[0].videos,let themes = self.ShowData[0].categories{
                                ...
                                if self.ShowData[0].single_video == 1 {
                                    self.metaDataViewHeight.constant = self.videoImageHeight.constant + 40
                                    ...
                                    self.mainViewHeight.constant = self.seasonTableViewHeight.constant + self.metaDataViewHeight.constant
