...
enum Theme: Int {
  ...
  var PrivacyPolicyURL: String {
    return "https://staging.iptvsolutionsgroup.com/privacypolicy"
  }
  var TermsAndConditionURL: String {
    return "https://staging.iptvsolutionsgroup.com/termsandconditions"
  }
  //screen change
  ...
  var emailAddress: String {
    return "info@iptvsolutionsgroup.com"
  }
