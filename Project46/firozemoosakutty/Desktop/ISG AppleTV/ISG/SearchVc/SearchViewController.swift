...
//    @IBOutlet weak var noresultView: UIView!
    ...
    weak var serachSuggetsionDelegate : SearchSuggestionDelegate?
...
//              }
   ...
   override func viewWillAppear(_ animated: Bool) {
    ...
    @objc func getSearchSuggestions(searchKeyword: String!) {
        print("getSearchResults")
        ApiCommonClass.getHomeSearchSuggestionResults(searchText: searchKeyword, searchType: type , category: categoryId,liveflag:liveflag) { (responseDictionary: Dictionary) in
            
            self.searchSuggestionArray.removeAll()
...
//              searchController.searchSuggestions = searchSuggestionArray
...
//                        self.serachSuggetsionDelegate?.updatedSearchSuggestions(searchSuggestionModel: self.searchSuggestionArray)
                    }
                }
            }
        }
        ...
        if let searchString = searchController.searchBar.text, !searchString.isEmpty {
            ...
            searchController.searchBar.resignFirstResponder()
             if searchString.trimmingCharacters(in: .whitespaces) != "" {
                getSearchSuggestions(searchKeyword:searchString.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed))
